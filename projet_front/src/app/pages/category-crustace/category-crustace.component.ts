...
@Component({
  selector: 'app-category-crustace',
  imports: [DetailsProduitsComponent, NavbarComponent],
  templateUrl: './category-crustace.component.html',
  styleUrl: './category-crustace.component.scss',
})
export class CategoryCrustaceComponent {
